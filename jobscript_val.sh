...
python test_script.py --folder /data101/makinen/pk_cmass/4Lucas/fastpm_summaries/kmin-0.0_kmax-0.3/raw/ --experiment "${arr[${SLURM_ARRAY_TASK_ID}]}" --device cpu --test-folder /data101/makinen/pk_cmass/4Lucas/quijote_summaries/kmin-0.0_kmax-0.3/
